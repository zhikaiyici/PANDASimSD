...
public:
	...
	static inline  array<G4int, 2> GetPositionOfNeutrino() { return neutrinoPosition; }

	static inline void SetPositionOfNeutrino(array<G4int, 2> np) { neutrinoPosition = np; }
...
private:
	...
	static array<G4int, 2> neutrinoPosition;
